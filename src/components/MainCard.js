...
import { Box, Card, CardActions, CardContent, CardHeader, Divider, IconButton, Typography } from '@mui/material';
                ...
                >
                  <IconButton color="secondary" size="small" sx={{ fontSize: '0.875rem', width: 'auto' }}>
                    ...
                    <Typography ml="0.5rem">
                      <FormattedMessage id="lbl.copy_source" />
                    </Typography>
                  </IconButton>
                </CopyToClipboard>
              </CardActions>
...
MainCard.propTypes = {
  ...
  exempleString: PropTypes.string,
  sx: PropTypes.object,
